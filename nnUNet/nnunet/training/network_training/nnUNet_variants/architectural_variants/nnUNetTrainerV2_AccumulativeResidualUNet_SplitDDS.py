"""
Trainer for the Projected Accumulative Residuals (PAR) UNet.

Uses Generic_UNet_AccumulativeResidual_SplitDDS:
  - PAR injection at every conv block (softmax-weighted history of same-resolution outputs)
  - Split input residual at every conv block
  - Encoder deep supervision

Deep supervision scales and loss weights match the PerConv_SplitDDS convention:
  decoder outputs (high->low res) + encoder outputs (high->low res, incl. bottleneck)
"""
...
from nnunet.network_architecture.generic_UNet_AccumulativeResidual import (
    Generic_UNet_AccumulativeResidual_SplitDDS,
)
...
class nnUNetTrainerV2_AccumulativeResidualUNet_SplitDDS(nnUNetTrainerV2):
    ...
    def initialize_network(self):
        ...
        self.network = Generic_UNet_AccumulativeResidual_SplitDDS(
    ...
    def initialize(self, training=True, force_load_plans=False):
        ...
        if training:
            ...
            # Zero out lowest-res decoder output and two lowest-res encoder outputs
