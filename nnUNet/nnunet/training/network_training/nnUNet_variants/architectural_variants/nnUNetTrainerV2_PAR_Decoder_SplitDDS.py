"""
Trainer for PAR v2: per-stage, cross-resolution (downsample only),
decoder injection before skip concatenation.

Uses Generic_UNet_PAR_Decoder_SplitDDS:
  - Encoder: split input residual (unchanged from PerConv_SplitDDS)
  - Decoder: PAR injected before each skip concat, then split residual inside blocks
...
from nnunet.network_architecture.generic_UNet_AccumulativeResidual import (
    Generic_UNet_PAR_Decoder_SplitDDS,
)
...
class nnUNetTrainerV2_PAR_Decoder_SplitDDS(nnUNetTrainerV2):
    ...
    def initialize_network(self):
        ...
        self.network = Generic_UNet_PAR_Decoder_SplitDDS(
